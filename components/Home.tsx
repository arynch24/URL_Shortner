...
>>>>>>> a58234fea2053b12f04bf865d898d9d75e45728e
...
<<<<<<< HEAD
            <div className='md:max-w-3xl'>
                <div className="flex flex-col gap-10">
                    <div className="text-xs md:text-base  w-fit flex items-center text-zinc-700 gap-2 border border-zinc-400 px-4 py-1 rounded-full">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold pb-4 bg-gradient-to-r from-sky-500 to-blue-950 bg-clip-text text-transparent">with superpowers</h1>
=======
            <div className='md:max-w-3xl '>
                <div className="flex flex-col gap-10">
...
<<<<<<< HEAD
                        ...
                        <button className='text-xs md:text-base w-full text-center text-zinc-600 bg-zinc-100 rounded-md p-2'>Shorten URL</button>
                    </div>
...
<<<<<<< HEAD
                        <div className='flex gap-4 items-center'>
                            <div className='text-xs md:text-sm flex items-center gap-2'><Eye size={20} className='text-bf-blue' /> 62.6K Clicks</div>
=======
